...
from danzer_anonymizer.danzer_anonymizer.core.anonymization.numerical.numerical_perturbation import NumericalPerturbation
from danzer_anonymizer.danzer_anonymizer.datasource.connector.file_system_connector import FileSystemConnector
from danzer_anonymizer.danzer_anonymizer.util.json_util import read_json_file
...
def run():
    ...
    column_suppression.inplace = True
